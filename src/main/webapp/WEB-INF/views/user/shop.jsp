        ...
        <div class="inner-top__main wrapper">
            <div class="inner-top__cols">
                <div class="inner-top__left">
                    <h1 class="inner-top__title"><s:message code="user.shop"/></h1>
                    <div class="breadcrumbs">
                        <ul class="breadcrumbs__list">
                            <li class="breadcrumbs__item">
                                <a class="breadcrumbs__link" href="index"><s:message code="user.home"/></a>
                            </li>➥&#160;&#160;
                            <li class="breadcrumbs__item"><s:message code="user.shop"/></li>
                        </ul>
                    </div>
                </div>
            ...
            <aside class="shop__left">
                <form action="shop/search" method="post">
                    <div class="search-form">
                        <input class="search-form__input" type="text" name="keywords" value="${keywords}" placeholder="<s:message code="user.searchph"/>">
                        <button class="search-form__button" type="submit"></button>
                    </div>
                </form>
                <div class="filters">
                    <section class="widget js-slidedown">
                        <h2 class="widget__title widget__title_hide-mob"><s:message code="user.category"/></h2>
                        <a class="widget__button js-slidedown-button" href="javascript:void(0);"><s:message code="user.category"/></a>
                    ...
                    <form action="shop/price" method="post">
	                    <section class="widget js-slidedown">
	                        ...
	                        <h3 class="widget__title widget__title_hide-mob"><s:message code="user.price"/></h3>
	                        <div class="widget__hide js-slidedown-hide">
	                            <div class="range">
						...
						<button class="apply-button button">
						    <span class="button__text"><s:message code="user.apply"/></span>
						</button>
					</form>
                </div>
                                ...
                                <div class="sale-banner__row">
                                    <div class="sale-banner__cell">
                                        <div class="sale-banner__content">
                                            <h4 class="sale-banner__title">Season <span>sale</span></h4>
                                            <p class="sale-banner__text">Non aliqua reprehenderit reprehenderit culpa laboris nulla</p>
                                            <a class="sale-banner__more read-more"><s:message code="user.shopnow"/></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="shop__right">
                ...
                <div class="shop-panel">
                    <div class="shop-panel__left">
                        <span class="shop-panel__text"><s:message code="user.shoptext"/> <b>${product}</b> <s:message code="user.shoptext1"/></span>
                    </div>
                    <div class="shop-panel__right">
                        <div class="shop-panel__select select select_1">
                            <select class="js-formstyler" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
            ...
            <div class="newsletter__main">
                <div class="newsletter__bg">
                    <div class="newsletter__max">
                        <h4 class="newsletter__title"><s:message code="user.news"/></h4>
                        <p class="newsletter__text"><s:message code="user.newstext"/></p>
                        <form>
                            <div class="newsletter-form">
                                <div class="newsletter-form__left">
                                    <input class="newsletter-form__input text-input" type="email" placeholder="<s:message code="user.emailph"/>">
                                </div>
                                <div class="newsletter-form__right">
                                    <button class="newsletter-form__button button">
                                        <span class="button__text"><s:message code="user.subscribe"/></span>
                                    </button>
                                </div>
                            </div>
                        </form>
