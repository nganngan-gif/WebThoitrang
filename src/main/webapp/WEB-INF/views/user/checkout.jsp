        ...
        <div class="inner-top__main wrapper">
            <div class="inner-top__cols">
                <div class="inner-top__left">
                    <h1 class="inner-top__title"><s:message code="user.checkout"/></h1>
                    <div class="breadcrumbs">
                        <ul class="breadcrumbs__list">
                            <li class="breadcrumbs__item">
                                <a class="breadcrumbs__link" href="index"><s:message code="user.home"/></a>
                            </li>➥&#160;&#160;
                            <li class="breadcrumbs__item"><s:message code="user.checkout"/></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="checkout-page__left">
                <form action="checkout" method="post">
                    <section class="checkout-form">
                        <h2 class="checkout-form__title"><s:message code="user.receiver"/></h2>
	                    <span class="login-form__label"><s:message code="user.phone"/> *</span>
                        <input class="text-input" type="number" name="phone" placeholder="<s:message code="user.phoneph"/>" required>
	                    <span class="login-form__label"><s:message code="user.address"/> *</span>
                        <textarea class="checkout-form__textarea textarea" name="address" placeholder="<s:message code="user.addressph"/>" required></textarea>
                        <div class="checkout-form__buttons">
                            <div class="checkout-form__button-col">
                                <a href="cart" class="checkout-form__back back-button"><s:message code="user.return"/></a>
                            </div>
                            <div class="checkout-form__button-col">
                                <button class="checkout-form__button button">
                                    <span class="button__text"><s:message code="user.confirm"/></span>
                                </button>
                            </div>
                        </div>
                    </section>
