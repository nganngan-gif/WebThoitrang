        ...
        <div class="inner-top__main wrapper">
            <div class="inner-top__cols">
                <div class="inner-top__left">
                    <h1 class="inner-top__title"><s:message code="user.product"/></h1>
                    <div class="breadcrumbs">
                        <ul class="breadcrumbs__list">
                            <li class="breadcrumbs__item">
                                <a class="breadcrumbs__link" href="index"><s:message code="user.home"/></a>
                            </li>➥&#160;&#160;
                            <li class="breadcrumbs__item"><s:message code="user.product"/></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="product-gallery">
                    <div class="product-gallery__top">
                        <div class="product-gallery__cols">
                            <div class="product-gallery__col">
                                ...
                                <div class="product-gallery__tag">
                                    <span class="item-tag item-tag_green"><s:message code="user.news"/></span>
                                </div>
                            </div>
                            <div class="product-gallery__col">
                    ...
                    <div class="product-slider loaded js-product-slider dots-2 dots-left">
                        <div class="product-slider__item">
                            <a class="product-slider__link" href="img/products/${item.img}"
                ...
                <div class="product__content">
                    ...
                    <ul class="chars">
                        <li class="chars__item">
                            <span class="chars__name"><s:message code="user.category"/>:</span>
                            <span class="chars__text">${item.category.name}</span>
                        </li>
                        <li class="chars__item">
                            <span class="chars__name"><s:message code="user.status"/>:</span>
                ...
                <div class="product-add">
                    <div class="product-add__col">
                        <a href="cart/add/${item.id}" class="product-add__button button">
                            <span class="button__text"><s:message code="user.addcart"/></span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="product-nav tabs-nav js-line">
            <ul class="product-nav__list tabs-nav__list tabs-nav__list_left">
                <li class="tabs-nav__item js-line-item js-tabs-item active">
                    <a class="tabs-nav__link js-line-link js-tabs-link" href="#product-tab-2"><s:message code="user.reviews"/></a>
                </li>
            </ul>
                ...
                <div class="product-tab__left">
                    <div class="reviews">
                        <article class="review">
                            ...
                            <p class="review__text">Proident voluptate adipisicing ullamco veniam incididunt
                                laboris nulla elit et anim tempor duis dolor nostrud. Ad eiusmod laborum
                                deserunt id eiusmod. Eiusmod ea aute ex et nisi exercitation eu fugiat.</p>
                        </article>
                        <article class="review">
                            <div class="review__top">
                                <div class="review__left">
                    ...
                    <form>
                        <section class="add-review">
                            <div class="add-review__top">
                                <h3 class="add-review__title"><s:message code="user.reviewstitle"/></h3>
                                <p class="add-review__text"><s:message code="user.reviewstext"/></p>
                            ...
                            <button class="add-review__button button">
                                <span class="button__text"><s:message code="user.reviewspost"/></span>
                            </button>
                        </section>
                    </form>
                </div>
