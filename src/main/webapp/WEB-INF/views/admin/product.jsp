					...
					<form:form action="admin/product" modelAttribute="item" enctype="multipart/form-data" cssClass="row">
						...
						<div class="col-xl-6">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<form:input type="text" path="id" cssClass="form-control" placeholder="123" />
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-2 col-form-label">
						...
						<div class="col-xl-6">
							...
							<!-- <div class="form-group row">
                                <label class="col-sm-2 col-form-label"><s:message code="admin.image" /></label>
                                <div class="col-sm-10">
                                   	<form:input type="file" path="img" class="custom-file-input"/>
									<label class="custom-file-label mx-3">Choose file</label>
									<span><form:errors path="img" cssClass="error" /></span>
                                </div>
                            </div> -->
						</div>
						<div class="col-xl-12">
				...
				<div class="card">
					<div class="card-body">
						...
						<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
							...
							<thead>
								<tr>
									<th><s:message code="admin.id" /></th>
									<th><s:message code="admin.nameproduct" /></th>
									<th><s:message code="admin.price" /></th>
									<th><s:message code="admin.date" /></th>
									<th><s:message code="admin.available" /></th>
									<!-- <th><s:message code="admin.image"/></th> -->
									<th><s:message code="admin.category1" /></th>
									<th>#</th>
								</tr>
							</thead>
							<tbody>
