...
<title><s:message code="admin.orderdetailmanage" /> | Molle Co., Ltd</title>
					...
					<div class="btn-group float-right">
						<ol class="breadcrumb hide-phone p-0 m-0">
							...
							<li class="breadcrumb-item active">
								<s:message code="admin.orderdetailmanage" />
							</li>
						</ol>
					</div>
					<h4 class="page-title">
						...
						<div class="card">
							<div class="card-body">
								<h4 class="mt-0 header-title">
									<s:message code="admin.orderdetaillist" />
								</h4>
								<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
									...
									<thead>
										<tr>
											...
											<th><s:message code="admin.quantity" /></th>
											<th><s:message code="admin.provisional" /></th>
										</tr>
									</thead>
									<tbody>
										<c:forEach var="item" items="${lists}">
											<tr>
												...
												<td><fmt:formatNumber type="currency" value="${item.price * item.quantity}"
														currencySymbol="$" /></td>
											</tr>
										</c:forEach>
									</tbody>
