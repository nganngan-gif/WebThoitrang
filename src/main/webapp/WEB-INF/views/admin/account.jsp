				...
				<div class="card">
					<div class="card-body">
						<h4 class="mt-0 header-title">
							<s:message code="admin.accountlist" />
						</h4>
						<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
							...
							<thead>
								<tr>
									...
									<th><s:message code="admin.password" /></th>
									<th><s:message code="admin.fullname" /></th>
									<th><s:message code="admin.email" /></th>
									<th><s:message code="admin.permission" /></th>
									<th><s:message code="admin.active" /></th>
							...
							<tbody>
								<c:forEach var="item" items="${items}">
									<tr>
										...
										<td class="text-center"><c:if test="${item.img == null}">
												<img class="w-50" src="img/accounts/noavt.png">
											</c:if> <c:if test="${item.img != null}">
