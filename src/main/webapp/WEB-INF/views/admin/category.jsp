							...
							<div class="row">
								...
								<div class="col-xl-6">
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="number" name="id" class="form-control" value="${item.id}" placeholder="123">
										</div>
									</div>
									<div class="form-group row">
				...
				<div class="card">
					<div class="card-body">
						<h4 class="mt-0 header-title">
							<s:message code="admin.categorylist" />
						</h4>
						<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
							...
							<thead>
								<tr>
									...
									<th><s:message code="admin.namecategory" /></th>
									<th>#</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach var="item" items="${items}">
									<tr>
										<td>${item.id}</td>
										<td>${item.name}</td>
										<td><a href="admin/category/edit/${item.id}" class="btn btn-sm btn-success text-white">
