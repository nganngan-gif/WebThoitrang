...
public class ProductController {
	...
	public String create(@Validated @ModelAttribute("item") ProductDTO productDTO, Product product, BindingResult br,
			@Parameter(name = "img") MultipartFile img, RedirectAttributes ra, Model model)
...
//			}
	...
	public String update(@Validated @ModelAttribute("item") ProductDTO productDTO, Product product,
			@Parameter(name = "category") Integer id, @Parameter(name = "img") MultipartFile img, BindingResult br,
